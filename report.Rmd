...
The final dataset contains data on 8 urinary phthalate metabolites and related information from 8149 participants in the National Health and Nutrition Examination Survey (NHANES) 2011–2016, including `r nrow(phthte_demo_bmx)` observations and `r ncol(phthte_demo_bmx)` variables.
