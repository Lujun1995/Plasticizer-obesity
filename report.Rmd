...
- **theme change:** Our group at first meant to do a project about obesity. But then we found it not fascinating enough and decided to switch theme to plasticizer pollution influencing the obesity of population.
...
The final dataset contains data for 8 urinary phthalate metabolites and related information from 8149 participants in the National Health and Nutrition Examination Survey (NHANES) 2011–2016. It contains `r nrow(phthte_demo_bmx)` observations and `r ncol(phthte_demo_bmx)` variables.
