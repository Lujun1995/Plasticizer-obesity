...
>>>>>>> 50ce9fc20735ea38f436ff9dc80cc8aee7ca8be1
```{r}
phthte_demo_bmx %>% 
...
We made barplots to show percent contribution of individual phthalates to the sum-total exposure among different subgroups. We found that mono-ethyl phthalate (MEP) contributed most to the sum-total exposure. And percent contribution patterns are different in child and adults and among different races.
...
<<<<<<< HEAD
## Violin plots of log(the sum-total exposure) among different subgroups
=======
### Distribution plots 
...
* Compared to other races, levels of the sum-total exposure were significantly higher in non_hispanic_black.
