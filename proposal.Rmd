...
Thus, we are interested in examining if current decline in NYC school student obesity rate is affected by changes in school demographic features [3]. If the misclassification of weight status in Asian population caused under-diagnosis or delayed detection of diabetes, and the potential loss caused by this problem.
