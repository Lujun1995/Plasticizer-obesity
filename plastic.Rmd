...
```{r}
phthte_gender_age = phthe_demo %>% 
  select(year, gender, race, phthe) %>% 
  nest(gender:phthe)


gender_age_plot = function(year, data) {
  ggplot(data, aes(x = "race", y = "phthe", fill = "gende"))
}
  
gender_age_plot(phthte_gender_age[[1,1]], phthte_gender_age[[1,2]])
```
